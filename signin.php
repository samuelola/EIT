...
<body>
    ...
    <input type="hidden" name="CSRF_TOKEN" id="CSRF_TOKEN" value="809bef91cc09ca0b1bf24aea2860e2ff">
    ...
    <input type="hidden" id="segment1" value="signin">
            ...
            <div class="col-xl-9">
                <div class="row mx-0 align-items-center border-md rounded-3">
                    <div class="col-md-6 border-end-md p-4 p-sm-5">
                        <h2 class="h3 mb-4 mb-sm-3">Hey there!<br>Welcome back.</h2>
                        <div class="mt-sm-2 text-center">Login as
                            <strong>
                                <a href="./ins-signin"
                                    class="text-decoration-underline">Instructor</a>
                            </strong>
                        </div>
                        <div class="mt-sm-2 mb-sm-4 text-center">Login as
                            <strong>
                                <a href="./affiliate-signin"
                                    class="text-decoration-underline">Affiliate</a>
                            </strong>
                        </div>
                        <img class="d-block mx-auto img-fluid" src="./application/modules/frontend/views/themes/default/assets/img/signin.svg"
                    ...
                    <h4>Student Sign in</h4>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-lg" name="email" type="text" id="email"
                                placeholder="Enter your Mobile Number or Email" tabindex="1" required="" autofocus>
                        </div>
                        ...
                        <button id="signin" class="btn btn-dark-cerulean btn-lg w-100 login_submit" type="button"
                            >Sign in</button>
                        </form>
                        <div class="col-6 text-right">
                            <a class="m-link-muted small" href="javascript:void(0)" onclick="forgotpassword_form()"
                                data-toggle="modal"
                                data-target="#forgotModal"><strong>Forgot Password ?</strong>
                            </a>
                        </div>
                        ...
                        <!-- <div class="text-center mt-3">
                            <a class="btn btn-outline-dark-cerulean btn-lg mb-3" href="https://accounts.google.com/o/oauth2/auth?response_type=code&access_type=online&client_id=827829191471-b5taif1smnq89ovvoccleg2cpma3rq1o.apps.googleusercontent.com&redirect_uri=https%3A%2F%2Flead.academy%2Fadmin%2Fsignin&state&scope=email%20profile&approval_prompt=auto"><i
                                class="fab fa-google me-1"></i></a>                            <a class="btn btn-outline-dark-cerulean btn-lg mb-3" href="https://www.facebook.com/v3.2/dialog/oauth?client_id=3227168540930718&state=78b5e0538cd665f4d805439ce2115637&response_type=code&sdk=php-sdk-5.7.0&redirect_uri=https%3A%2F%2Flead.academy%2Ffrontend%2Ffrontend%2Fsigninbyfacebook%2F&scope=email"><i class="fab fa-facebook me-1"></i></a>
                        </div>
                        
                        <div class="text-center">
                            <p style="color:#11487B; font-size:14px;"><strong>Social Signin</strong></p>
                        </div> -->

                        <div class="mt-sm-4 text-center">Don't have an account?
                            <strong>
                                <a href="./signup"
                                    class="text-decoration-underline">Create an Account</a>
                            </strong>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function (e) {
        ...
        $(document).on('click', '#signin', function(event){
            ...
            $.ajax({
                ...
                $(".login_submit").prop('disabled', true); // disable button
                
                    // $('.registerbtn').html('<img src= '+ src +' alt="loader" /> &nbsp; Loading...');
                    $('.login_submit').html('<div id="spin" class="spinner-border" style="width: 1.5rem;height: 1.5rem;position: relative;top: 2px;"></div>');
                },

                success: function (data) {

                    console.log(data.emailenotxists);

                    if(data.emailenotxists){
                    ...
                    }else if(data.passwordnotexists){
