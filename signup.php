...
<body>
    ...
    <input type="hidden" name="CSRF_TOKEN" id="CSRF_TOKEN" value="776af3aae22c137ae1061ee976ca304e">
    ...
    <input type="hidden" id="segment1" value="student-signup">
                    ...
                    id="navbarSticky">
                        ...
                        <a class="navbar-brand ms-0 ms-md-2"
                            ...
                            <img src="./eit-white.png"
                                class="img-fluid" alt="" id="waylogo">
                        </a>
                    </div>
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav flex-row align-items-center">
                            ...
                            <li class="nav-item m-1">
                                <a id="waylogo1" class="border btn fw-bold me-2 text-uppercase text-white py-1 px-2 d-flex align-items-center"
                                    href="./signin"><i
                            ...
                            <li class="nav-item ml-md-3">
                                <a id="waylogo2" href="signup"
                                    class="btn-join btn-join-alabin bg-white btn fw-bold text-dark-cerulean text-uppercase d-flex align-items-center"><i
                                        class="far fa-edit me-0 me-sm-2"></i><span class="d-none d-sm-flex">join Eko Institute of Technology</span>                                </a>
                            </li>
...
<div class="content_search" style="margin-top:70px">
    <link rel="stylesheet" href="./application/modules/frontend/views/themes/default/assets/css/intlTelInput.css">
            ...
            <div class="col-xl-9">
                <div class="border-md mx-0 rounded-3 row">
                    <div class="border-end-md col-md-6 p-sm-5 px-5">
                        <h2 class="h3 mb-4 fw-bold text-uppercase align-items-center" style="text-align:center">Join Eko Institute of Technology</h2>
                        <h4 class="mb-0" style="font-size:20px ;text-align:center">Get Unlimited Access To World Class Online Learning</h4>
                        <br>
                        <center class="text-center">
                        <a href="./ins-signup"><strong>Become an Instructor</strong></a> 
                        </center>
                        <center class="text-center">
                        <a href="./affiliate-signup"><strong>Become an Affiliate</strong></a> 
                        </center>
                        <img class="d-block img-fluid mx-auto" style="margin-top:100px" src="./application/modules/frontend/views/themes/default/assets/img/signup.svg"
                    ...
                    <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                        ...
                        <form action="./#" class="myform" id="student" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                            <input type="hidden" name="csrf_test_name" value="776af3aae22c137ae1061ee976ca304e" />

                        <input type="hidden" id="user_typee" value="learner">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label mb-1" for="mobile">Mobile</label>
                            <input class="form-control form-control-lg" type="number" id="mobile" onkeyup="mobilecheck()" required="">
                        </div>
                        <div class="mb-3">
                            <label class="form-label mb-1" for="email">Email address</label>
                            <input class="form-control form-control-lg" type="email" id="email" onkeyup="mailcheck()"
                                placeholder="Enter your email" required="">
                        </div>
                        <div class="mb-3 position-relative">
                            <label class="form-label mb-1" for="password">Password                                <!-- <small class="fs-sm text-muted">(min. 8 char)</small> -->
                            </label>
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="agree-to-terms">By joining,  I read and agree to the <a
                                    ...
                                    <a target="_blank" href="./refund-policy" class="text-decoration-underline"> and Return and Refund Policy.</a>
                            </label>
                                    <!-- <br>
                        ...
                        <!-- <button class="btn btn-dark-cerulean btn-lg w-100 registerbtn" onclick="register_save(4)"
                            ...
                            <button class="btn btn-dark-cerulean btn-lg w-100 registerbtn" id="signupp"
                            type="button">Sign up</button>
                        </form>                        <div class="mt-sm-4 text-center">Already have an account?
                            <strong>
                                <a href="./signin"
...
<script src="./application/modules/frontend/views/themes/default/assets/js/intlTelInput.js"></script>
<script  src="./application/modules/frontend/views/themes/default/assets/js/utils.js"></script>
...
$(document).ready(function (e) {
  ...
  if (!regex.test(email)) {
    ...
    $(document).on('click', '#signupp', function(event){
        ...
        if (name == "") {
            ...
            // $("#name").css({ border: "2px solid red" }).focus();
            toastrErrorMsg("Need At least 3  Characters!");
            return false;
        }
  ...
  $.ajax({
    ...
    beforeSend: function() { 
      ...
      $(".registerbtn").prop('disabled', true); // disable button
        ...
        $('.registerbtn').html('<div id="spin" class="spinner-border" style="width: 1.5rem;height: 1.5rem;position: relative;top: 2px;"></div>');
    },
    ...
    if (data.emailexists) {
        ...
        setTimeout(function () {
            ...
            toastr.success("Registration is Successfull!");
        }, 1000);
