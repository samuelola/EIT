            ...
            <div class="col-xl-9">
                <div class="row mx-0 align-items-center border-md rounded-3">
                    ...
                    <h4>Admin Sign in</h4>
                        ...
                        <button id="adminsignin" class="btn btn-dark-cerulean btn-lg w-100 login_submit" type="button"
                            >Sign in</button>
                        </form>
...
<script>
    $(document).ready(function (e) {
        ...
        $(document).on('click', '#adminsignin', function(event){
            ...
            $.ajax({
                ...
                url:'dashboard/processadminlogin.php',
                type: "POST",
                dataType: 'json',
                ...
                success: function (data) {
                    ...
                    console.log(data.emailenotxistsad);

                    if(data.emailenotxistsad){
                    ...
                    }else if(data.passwordnotexistsad){
