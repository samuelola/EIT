  ...
  <div class="modal-dialog  modal-lg" >
    <div class="modal-content" >
      ...
      <div class="modal-body">
           <!-- <video id="mainVideo" width="100%" controls controlsList="nodownload" preload="metadata" style="height:400px">
                <source class="theimagee" type="video/mp4">
                                        ...
                                        <div class="user-header">
                                            <div class="align-items-center d-flex mb-3">
                                                ...
                                                <div class="p_info ms-3">
                                                    <h6 class="mb-2 text-white"><?php echo isset($myrell['name']) ? ucfirst($myrell['name']) : '' ?>                                                    </h6>
                                                    <p class="mb-0"><?php echo isset($myrell['user_type']) ? ucfirst($myrell['user_type']) : '' ?>
                                                        Account</p>
                                                </div>
                                            </div><!-- img-user -->
                                        </div><!-- user-header -->
                            ...
                            <div
                                ...
                                <div class="position-relative overflow-hidden bg-prussian-blue">
                                    ...
                                    <div class="course-card__hover--content">
                                        ...
                                        <a id="mega" data-link="<?php echo $row['youtube_link'] ?>" data-bs-toggle="modal" onclick="playPause()" data-bs-target="#videoModal" class="course-card__hover--content___icon popup-youtube"
                                            href="#"
                                            autoplay>
                                            <img src="./application/modules/frontend/views/themes/default/assets/img/Playicon.png"
                                                class="img-fluid" alt="">
