...
$sqlcourse = "SELECT * FROM admin WHERE uuid = '$getcourseid'";

$querycourse = mysqli_query($conn,$sqlcourse);
$mycourses = mysqli_fetch_array($querycourse);
            ...
            <div class="col-md-9 sticky-content">
                ...
                <div id="alldata">
                    <div class="row justify-content-center gx-3 gy-4">
                     ...
                     -->
                         <input type="hidden" name="id" id="id" value="<?php echo isset($mycourses['id']) ? $mycourses['id'] : '' ?>">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-lg" name="title" type="text" id="title"
                                        placeholder="Enter your title" tabindex="1" value="<?php echo isset($mycourses['title']) ? $mycourses['title'] :'' ?>"  autofocus>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="mb-3" style="position : relative">
                                    ...
                                    <input class="form-control form-control-lg" name="description" type="text" id="description"
                                        placeholder="Enter Description" tabindex="2" value="<?php echo isset($mycourses['description']) ? $mycourses['description'] :'' ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3" style="position : relative">
                                    ...
                                    <input class="form-control form-control-lg" placeholder="Enter Author" name="author" type="text" id="author"
                                        tabindex="2"  value="<?php echo isset($mycourses['author']) ? $mycourses['author'] :'' ?>">
                                    ...
                                    <div class="mb-3" style="position : relative">
                                        ...
                                        <option value="">--Select--</option>
                                            <?php 
                                              ...
                                              if($mycourses['level'] == 'Beginner Level'){

                                                ?>
                                                <option value="Beginner Level" selected>Beginner Level</option>
                                                <option value="Intermediate Level">Intermediate Level</option>
                                                <option value="Advanced Level">Advanced Level</option>
                                                
                                                <?php

                                              }elseif($mycourses['level'] == 'Intermediate Level'){
                                                ...
                                                <option value="Beginner Level">Beginner Level</option>
                                                <option value="Intermediate Level">Intermediate Level</option>
                                                <option value="Advanced Level" selected>Advanced Level</option>
                            ...
                            <div class="col-md-6">
                                    <div class="mb-3" style="position : relative">
                                        ...
                                        <input class="form-control form-control-lg" name="image" type="file" id="image"
                                            tabindex="2" value="<?php echo isset($mycourses['image']) ? $mycourses['image'] : '' ?>">
                            ...
                            <div class="col-md-6">
                                   <div class="mb-3" style="position : relative">
                                        ...
                                        <input class="form-control form-control-lg" placeholder="Enter Discount Price" name="price" type="number" id="price"
                                            tabindex="2" value="<?php echo isset($mycourses['price']) ? $mycourses['price'] :'' ?>">
                            ...
                            <div class="col-md-6">
                                    <div class="mb-3" style="position : relative">
                                        ...
                                        <input placeholder="Enter Youtube Link" class="form-control form-control-lg" name="youtube_link" type="text" id="youtube_link"
                                            tabindex="2"  value="<?php echo isset($mycourses['youtube_link']) ? $mycourses['youtube_link'] :'' ?>">
                            ...
                            <div class="col-md-6">
                                   <div class="mb-3" style="position : relative">
                                        ...
                                        <input class="form-control form-control-lg" name="old_price" type="number" id="old_price"
                                            tabindex="2"  value="<?php echo isset($mycourses['old_price']) ? $mycourses['old_price'] :'' ?>">
                        ...
                        <div class="row">
                            ...
                            <button id="editadmincourse" class="btn btn-dark-cerulean btn-lg w-100 editadmincourse" type="button"
                            >Edit Course</button>
                            </div>
                        </div>
...
<script>
    $(document).ready(function (e) {
        ...
        $(document).on('click', '#editadmincourse', function(event){
        ...
        //    }
           ...
           $.ajax({
            ...
            url:'editadmincourse.php',
                ...
                $(".editadmincourse").prop('disabled', true); // disable button
                
                    $('.editadmincourse').html('<div id="spin" class="spinner-border" style="width: 1.5rem;height: 1.5rem;position: relative;top: 2px;"></div>');
                },
                success: function (data) {
...
function removeLoader(){
    $( "#spin" ).fadeOut(500, function() {
        ...
        $(".editadmincourse").prop('disabled', false);
        $('.editadmincourse').html('Sign In');
  });  
}
</script>
