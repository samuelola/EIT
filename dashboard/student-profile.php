...
<body>
    ...
    <input type="hidden" id="segment1" value="student-profile-dashboard">
                                    ...
                                    <div class="notifications-scroll">
                                        <div
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <img class="me-1"
                                                    src="./application/modules/frontend/views/themes/default/assets/img/001-book.png">
                                                <span class="">
                                ...
                                <div class="dropdown-menu  dropdown-menu-right sm-menu animate slideIn"
                                    aria-labelledby="cart">
                                        ...
                                        <div
                                            ...
                                            <div class="position-relative">
                                                <img class="me-1"
                                                    src="./application/modules/frontend/views/themes/default/assets/img/bookmark-2.png">
                                                <span class="">
                                                </span>
                                            </div>
                                            <div class="shopping-cart-total">
                            ...
                            <li class="nav-item dropdown dmenu dropdown-bell" id="notification_load">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                    ...
                                    <i data-feather="bell" class="navbar-icon"></i>
                                                                        <span class="badge" id="notify_counter">0</span>
                                </a>
                                <div class="dropdown-menu  dropdown-menu-right sm-menu animate slideIn">
...
/* ============ its for crop css start =============== */
.image_area {
    position: relative;
}

.crop-profile-preview,
.crop-cover-preview {
    overflow: hidden;
    width: 100%;
    height: 100%;
...
<div class="student-profile-header hero-header text-white position-relative overflow-hidden" data-image-src="">
    <div class="bottom-0 end-0 position-absolute start-0 top-0" style="z-index: -1">
        <img src="./assets/img/default-600-400.png" alt="" style="width: 100%; height: 100%;">
    </div>
    <div class="container-lg hero-header_wrap position-relative">
        <div class="text-center">
            <div class="avatar-img mb-3">
                <img src="./assets/img/icons/default.png" alt="">
            </div>
            <h2 class="stydent-name"><?php echo isset($myrell['name']) ? ucfirst($myrell['name']) : '' ?></h2>
            <div class="fw-bold"><?php echo isset($myrell['user_type']) ? $myrell['user_type'] : '' ?></div>
            <div class="text-decoration-underline fw-bold"><?php echo isset($myrell['email']) ? $myrell['email'] : '' ?></div>
        </div>
    </div>
</div><!--End Student Profile Header-->
    ...
    <div class="container-lg">
               ...
               <li class="nav-item">
                   <a class="nav-link student-profile-dashboard"
                       href="./student-profile-dashboard">Profile/CV</a>
               </li>
               <!-- <li class="nav-item">
                   <a class="nav-link student-public-view"
                       href="./student-profile-show/ST16U666R88452">Public View</a>
               </li> -->
               <li class="nav-item">
                   <a class="nav-link student-activity"
                       href="./student-activity/">Activity</a>
               </li>
               <li class="nav-item">
                   <a class="nav-link student-notification"
                       href="./student-notification">Notification</a>
               </li>
               <li class="nav-item">
                   <a class="nav-link student-settings-account"
                       href="./student-settings-account">Settings</a>
               </li>
           </ul>
               </div>
</div>
                            ...
                            <div id="dropZ">
                                <div class="selectFile">
                                    ...
                                    <!-- <input type="file" name="profilepic" id="profilepic"
                                        onchange="1_studentprofilepictureupload(this)" accept='image/*'> -->
                                </div>
                            </div>
                        </div>
                        <div class="mt-1 text-danger">(Recommended: 120x120px)</div>
                    </div>
                    <input type="hidden" name="profile_croped_img" id="profile_croped_img">
                    <input type="hidden" name="profile_original_filename" id="profile_original_filename">
                    <div class="col-md-6 col-xl-3">
                        <div class="zone upload text-center">
                            <div id="dropZ2">
                                <div class="selectFile">
                                    ...
                                    <!-- <input type="file" name="coverpicture" id="coverpicture"
                                        onchange="1_studentcoverpictureupload(this)" accept='image/*'> -->
                                </div>
                            </div>
                        </div>
                        <div class="mt-1 text-danger">(Recommended: 1904x428px)</div>
                    </div>
                    <input type="hidden" name="cover_croped_img" id="cover_croped_img">
                    <input type="hidden" name="cover_original_filename" id="cover_original_filename">
                    <div class="col-md-6 col-xl-3">
                        <div class="zone upload text-center ">
                            <a href="./student-profile-edit"
                                style="min-width: 260px;line-height: 24px;" class="btn btn-lg btn-dark-cerulean mb-2">
                                <i data-feather="edit-3" class="me-2"></i>Edit Profile</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3">
                        <div class="zone upload text-center ">
                            <a href="./student-profile-show/ST16U666R88452"
                                style="min-width: 260px;line-height: 24px;"
                                class="btn btn-lg btn-dark-cerulean mb-2 text-white"> <i data-feather="eye"
                                    class="me-2"></i>Public View</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="thumbnail-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="img-container">
                    <div class="row">
                        <div class="col-md-9">
                            <img src="" id="thumbnail_sample_image" class="img-fluid" />
                        </div>
                        <div class="col-md-3">
                            <div class="crop-profile-preview"></div>
                            <div class="thumbnail-dimension-show">
                                <input type="hidden" readonly class="thumbnail-dimension-width"></span>
                                <input type="hidden" readonly class="thumbnail-dimension-height"></span>
                            </div>

                            <div class="btn-group">
                                &nbsp;
                                <button id="thumb-ZoomInBtn" type="button" class="btn btn-primary" data-method="zoom"
                                    data-option="0.1" title="Zoom In">
                                    <span class="docs-tooltip" data-toggle="tooltip" title="Zoom IN">
                                        <span class="fa fa-search-plus">+</span>
                                    </span>
                                </button> &nbsp;
                                <button id="thumb-ZoomOutBtn" type="button" class="btn btn-primary" data-method="zoom"
            ...
            <div class="modal-footer">
                <button type="button" id="thumbnail-crop" class="btn btn-primary">Crop</button>
...
<div class="modal fade" id="coverpicture-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="img-container">
                    <div class="row">
                        <div class="col-md-12">
                            <img src="" id="coverpicture_sample_image" class="img-fluid" />
                        </div>
                        <div class="col-md-12">
                            <div class="crop-cover-preview"></div>
                            <div class="coverpicture-dimension-show">
                                <input type="hidden" readonly class="coverpicture-dimension-width"></span>
                                <input type="hidden" readonly class="coverpicture-dimension-height"></span>
                            </div>

                            <div class="btn-group">
                                &nbsp;
                                <button id="coverpicture-ZoomInBtn" type="button" class="btn btn-primary"
                                    data-method="zoom" data-option="0.1" title="Zoom In">
                                    <span class="docs-tooltip" data-toggle="tooltip" title="Zoom IN">
                                        <span class="fa fa-search-plus">+</span>
                                    </span>
                                </button> &nbsp;
                                <button id="coverpicture-ZoomOutBtn" type="button" class="btn btn-primary"
            ...
            <div class="modal-footer">
                <button type="button" id="coverpicture-crop" class="btn btn-primary">Crop</button>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 rounded-0 shadow-sm">
            <div class="card-body p-4 p-xl-5">
                <div class="mb-3">
                    ...
                    <?php echo isset($myrell['name']) ? ucfirst($myrell['name']) : '' ?></h4>
                    <div>
                                            </div>
                </div>
...
$(document).ready(function() {
    // ============== its for course thumbnail croping ==============
    var cropper;
    var $modal = $('#thumbnail-modal');
    var image = document.getElementById('thumbnail_sample_image');

    $('#profilepic').change(function(event) {
        var files = event.target.files;
        var profile_original_filename = event.target.files[0].name;
        $("#profile_original_filename").val(profile_original_filename);
    ...
    $modal.on('shown.bs.modal', function() {
        cropper = new Cropper(image, {
            ...
            crop: function(event) {
                $(".thumbnail-dimension-width").val(event.detail.width);
                $(".thumbnail-dimension-height").val(event.detail.height);
            },
        });
    ...
    $('#thumb-ZoomInBtn').click(function(e) {
        cropper.zoom(0.1);
    });

    $('#thumb-ZoomOutBtn').click(function(e) {
        cropper.zoom(-0.1);
    });

    $('#thumbnail-crop').click(function() {
        var thumbnail_dimension_width = 120 //$(".thumbnail-dimension-width").val();
        var thumbnail_dimension_height = 120 //$(".thumbnail-dimension-height").val();
        ...
        canvas.toBlob(function(blob) {
            ...
            reader.onloadend = function() {
                ...
                // alert(base64data);return false;
                $("#profile_croped_img").val(base64data);
                // $('#thumbnail-preview-img').attr('src', base64data);
                var fd = new FormData();
                // fd.append("profilepic", $("#profilepic")[0].files[0]);
                fd.append("profilepic", $("#profile_croped_img").val());
                fd.append("profile_original_filename", $("#profile_original_filename")
                    .val());
                ...
                // var base_url = "";
                // fd.append("profilepic", $("#profile_croped_img").val());
                // fd.append("profile_original_filename", $("#profile_original_filename").val());
                // fd.append("enterprise_id", enterprise_id);
    ...
    // ================== close thumbnail croping =============

    // ============== its for cover croping ==============
    var $modal_cover = $('#coverpicture-modal');
    var image_cover = document.getElementById('coverpicture_sample_image');

    $('#coverpicture').change(function(event) {
        var files = event.target.files;
        var cover_original_filename = event.target.files[0].name;
        $("#cover_original_filename").val(cover_original_filename);
        var done = function(url) {
            image_cover.src = url;
    ...
    $modal_cover.on('shown.bs.modal', function() {
        cropper = new Cropper(image_cover, {
            ...
            crop: function(event) {
                // console.log(event);
                $(".coverpicture-dimension-x").val(event.detail.x);
                $(".coverpicture-dimension-y").val(event.detail.y);
                $(".coverpicture-dimension-width").val(event.detail.width);
                $(".coverpicture-dimension-height").val(event.detail.height);
                $(".coverpicture-dimension-rotate").val(event.detail.rotate);
                $(".coverpicture-dimension-scalex").val(event.detail.scaleX);
                $(".coverpicture-dimension-scaley").val(event.detail.scaleY);
            },
        });
    }).on('hidden.bs.modal', function() {
        cropper.destroy();
    ...
    $('#coverpicture-ZoomInBtn').click(function(e) {
        cropper.zoom(0.1);
    });

    $('#coverpicture-ZoomOutBtn').click(function(e) {
        cropper.zoom(-0.1);
    });


    $('#coverpicture-crop').click(function() {
        var coverpicture_dimension_width = 1904 //$(".coverpicture-dimension-width").val();
        var coverpicture_dimension_height = 428 //$(".coverpicture-dimension-height").val();
        canvas = cropper.getCroppedCanvas({
            width: coverpicture_dimension_width,
            height: coverpicture_dimension_height
        });
        ...
        canvas.toBlob(function(blob) {
            ...
            reader.onloadend = function() {
                ...
                $("#cover_croped_img").val(base64data);
                var fd = new FormData();
                // alert(CSRF_TOKEN);
                // alert(base_url);return false;
                // fd.append("coverpicture", $("#coverpicture")[0].files[0]);
                fd.append("coverpicture", $("#cover_croped_img").val());
                fd.append("cover_original_filename", $("#cover_original_filename").val());
                fd.append("enterprise_id", enterprise_id);
                fd.append("csrf_test_name", CSRF_TOKEN);
                $.ajax({
                    url: base_url + enterprise_shortname +
                        "/student-cover-picture-update",
                    type: "POST",
                    data: fd,
                    enctype: "multipart/form-data",
                    processData: false,
...
<div class="sub-footer bg-prussian-blue text-white py-4">
    <div class="container-lg d-sm-flex align-items-center justify-content-between">
        ...
        <ul class="footer-social list-unstyled mb-0 d-flex align-items-center justify-content-center mt-3 mt-sm-0">
            ...
            <li class="mx-1">
                <a
                    href="https://www.facebook.com/leadacademy.com.bd">
            ...
            <li class="mx-1">
                <a
                    href="https://www.youtube.com/c/LEADLeadershipExcellenceDevelopment">
