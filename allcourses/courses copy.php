...
<div class="modal fade" id="Geeks2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" >
      ...
      <!-- <iframe id="Geeks3" class="yty" width="450" height="350"
                                   
                                    frameborder="0" allowfullscreen>
                            </iframe> -->
    <iframe id="Geeks3" width="460" height="315" class="yty" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

           
           <!-- <iframe id="theimagee" width="560" height="315" frameborder="0" allowfullscreen></iframe> -->
           <!-- <iframe id="theimagee" width="560" height="315"  frameborder="0" allowfullscreen></iframe> -->
      </div>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="#"
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="#">Entrepreneurship</a>
                                                </li>
                                                                                                <li><a
                                                        href="#">Supply Chain &amp; Logistics</a>
                                                </li>
                                                                                                <li><a
                                                        href="#">Networking &amp; Negotiation</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="#">Personal Productivity</a>
                                                </li>
                                                                                                <li><a
                                                        href="#">Professional Productivity</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            ...
                                            <ul>
                                                        ...
                                                        href="#">English Language</a>
                                                                                                ...
                                                                                                <li><a
                                                        href="#">Quran Learning</a>
                                                </li>
                                                                                                <li><a
                                                        href="#">Sign Language</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="#">Practical Accounting</a>
                                                </li>
                                                                                                <li><a
                                                        href="#">Investing &amp; Trading</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="#">Python Programming</a>
                                                </li>
                                                                                                <li><a
                                                        href="#">Matlab Programming</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            ...
                                            <ul>
                                                        ...
                                                        href="#">Web Design</a>
                                                                                                ...
                                                                                                <li><a
                                                        href="#">Full Stack Web Development</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
            ...
            <div class="col-md-3 pe-xl-5 d-none d-md-block sticky-content">
                ...
                <div class="sidebar-filter">
                    <h4 class="fw-bold text-dark-cerulean mb-4"><a
                            href="#"
                            class="text-dark-cerulean">All Courses</a></h4>
                    ...
                    <!-- <ul class="list-unstyled cat-list my-3"> -->
                            ...
                            <label
                                class="ms-2">Sales And Marketing</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Advertising</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Corporate Sales</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                    ...
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Website Development </label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Wordpress</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Web Design</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Full Stack Web Development</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Programming Language</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Python Programming</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Matlab Programming</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Digital Marketing</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">SEO</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2"> Facebook Marketing</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Affiliate Marketing</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Social Work</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Volunteerism</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Psychological Development</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Mental Toughness</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Finance &amp; Accounting</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Practical Accounting</label></a></li>
                                                                        <li><a
                                href="category-course/C302ZXF5">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Investing &amp; Trading</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Language Learning</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">English Language</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Quran Learning</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Sign Language</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>

                                        <!-- <ul class="list-unstyled cat-list my-2"> -->
                    <!-- <li> -->
                                        <h6 class="fw-bold text-dark-cerulean cat_radio"><a style="color: #07477D;"
                            href="#">
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Business Communication</label></a></h6>
                    <!-- <hr class="my-2 bg-dark-cerulean"> -->
                    <!-- </li> -->
                    <hr class="my-2 bg-dark-cerulean">
                    <!-- </ul> -->
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Personal Development</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Personal Productivity</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Professional Productivity</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Microsoft Office</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">PowerPoint</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Ms Word</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Management Skills</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">  Leadership Development    </label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Creative Arts &amp; Crafts</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Calligraphy</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Magic Skills</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Business Management</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Entrepreneurship</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Supply Chain &amp; Logistics</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Networking &amp; Negotiation</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                    ...
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Pastry &amp; Baking</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Engineering</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Robotics</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Health &amp; Fitness</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Yoga</label></a></li>
                                                                        <li><a
                                href="#">
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Self Defense</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
                            ...
                            <!-- <input type="radio" name="" > -->
                            <label
                                class="ms-2">Cyber Security</label></a></h6>
                    <ul class="list-unstyled cat-list my-3 cat_radio">
                        <hr class="my-2 bg-dark-cerulean">
                                ...
                                <!-- <input type="radio" name="" > -->
                                <label
                                    class="ms-2">Ethical Hacking</label></a></li>
                                                <hr class="my-2 bg-dark-cerulean">
                    </ul>
            ...
            <div class="col-md-9 sticky-content">
                ...
                <div class="category-banner text-white p-4 p-sm-5 mb-4 position-relative overflow-hidden">
                    ...
                    <div class="position-relative">
                        <h2 class="fw-semi-bold">All Courses</h2>
                ...
                <div class="input-group course-search mb-4">
                    <input type="text" class="form-control typeaheads" id="items" placeholder="Search For Course"
                            ...
                            <div
                                ...
                                <div class="position-relative overflow-hidden bg-prussian-blue">
                                    ...
                                    <a href="#"
                                        ...
                                        <img src="../admin/dashboard/<?php echo $row['image']  ?>"
                                    ...
                                    <div
                                        class="align-items-center top-0 d-flex fs-12 position-absolute px-3 py-2 start-0 text-white w-100 z-index-2">
                                                                                ...
                                                                                <span
                                            class="badge-business"><?php echo $row['title']  ?></span>
                                        <span id="savecourseCO14I5QY856" class="ms-auto">
                                                                                        <img onclick="get_coursesaveloop(1, 'CO14I5QY856')"
                                        ...
                                        style="top:25px">
                                            ...
                                            <span class="d-block fs-13 mb-1">Off 50%</span>
                                    </span> -->
                                                                        <!--End items badge-->
                                    <!--End Course Image-->
                                    ...
                                    <div
                                        ...
                                        <h3 class="course-card__course--title  mb-0">
                                            <a href="course-details/CO14I5QY856"
                                                class="text-decoration-none text-white"><?php echo ucfirst($row['title']) ?></a>
                                        </h3>
                                        <!--End Course Title-->
                                        <div class="course-card__instructor d-flex align-items-center">
                                            <div class="card__instructor--name my-2">
                                                <a class="text-capitalize instructor-name"
                                                    href="instructor-profile-show/F141CZJYL8374"><?php echo ucfirst($row['author']) ?></a>
                                            </div>
                                        </div>
                                        <!--Start Course Hints-->
                                        <table
                                                    ...
                                                    <td width="80" class="ps-0">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <?php echo ucfirst($row['level']) ?>                                                           </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div
                                            ...
                                            <!-- <div class="course-like d-flex align-items-center">
                                                ...
                                                <div class="d-block">
                                                    <div class="reviews fs-12 fw-bold text-white">0</div>
                                                </div>
                                            </div> -->
                                    ...
                                    <div class="course-card__hover--content">
                                        <!-- <img src="assets/uploads/course/Hover1684048981-f-Amazon-mini-hover.png"
                                        ...
                                        <!-- <a class="course-card__hover--content___icon popup-youtube"
                                            href="https://vimeo.com/826598159"
                                            autoplay>
                                            <img src="./application/modules/frontend/views/themes/default/assets/img/Playicon.png"
                                                class="img-fluid" alt="">
                                        </a> -->

                                        <a id="holaa"  data-bs-toggle="modal" data-linker="<?php echo $row['youtube_link'] ?>"  data-bs-target="#Geeks2" class="course-card__hover--content___icon popup-youtube"
                                            href="#"
                                            autoplay>
                                            <img src="./application/modules/frontend/views/themes/default/assets/img/Playicon.png"
                                                class="img-fluid" alt="">
                                        ...
                                        <h3
                                            ...
                                            <a href="course-details/CO14I5QY856"
                                                class="text-decoration-none text-white"><?php echo ucfirst($row['description']) ?></a>
                                        </h3>
                                    </div>
                                </div>
                                    ...
                                    <input type="hidden" name="course_id"
                                        id="course_id_CO14I5QY856"
                                        value="CO14I5QY856">
                                    <input type="hidden" name="course_name"
                                        id="course_name_CO14I5QY856"
                                        value="Amazon Affiliate Marketing with SEO">
                                    <input type="hidden" name="slug"
                                        id="slug_CO14I5QY856"
                                        value="amazon-affiliate-marketing-with-seo">
                                    <input type="hidden" name="qty" id="qty" value="1">
                                    <input type="hidden" name="price"
                                        id="price_CO14I5QY856"
                                        value="750">
                                    <input type="hidden" name="old_price"
                                        id="old_price_CO14I5QY856"
                                        value="1500">
                                    <input type="hidden" name="picture"
                                        id="picture_CO14I5QY856"
                                        value="assets/uploads/course/Thumb1684048981-f-Amazon-Mini-thumb.png">
                                    ...
                                    <input type="hidden" name="course_price" id="course_price" value="750">
                                    ...
                                    <div class="d-block">
                                            ...
                                            <input class="me-1" style="width:21px;height:21px" type="radio"
                                                name="flexRadioDefault1_CO14I5QY856"
                                                id="flexRadioDefault1_CO14I5QY856"
                                                onclick="subscriptionchecedRadio('CO14I5QY856')"
                                                disabled>
                                        ...
                                        <div class="form-check d-flex align-items-center ps-0">
                                            <input class="me-1" style="width:21px;height:21px" type="radio"
                                                name="flexRadioDefault2_CO14I5QY856"
                                                id="flexRadioDefault2_CO14I5QY856"
                                                onclick="coursechecedRadio('CO14I5QY856')"
                                                checked>
                                            <label
                                                class="align-items-center d-flex form-check-label fw-bold justify-content-between"
                                                style="width:100%"
                                                for="flexRadioDefault2_CO14I5QY856">
                                                <span class="course_price_cart">Course Price <span
                                                        class="text-success"></span>
                                                </span>
                                                <span class="align-items-center d-flex  rounded text-center">
                                                    <span class="d-block fs-16 fw-bold me-2 text-success2"><?php echo $row['price'] ?></span>
                                                                                                        <del
                                                        class="fs-12 fw-bold text-muted2"><?php echo $row['old_price'] ?></del>
                                                                                                    </span>
                                                    ...
                                                    <span class="shopping me-1 shopping_icon position-relative">
                                                        <img src="application/modules/frontend/views/themes/default/assets/img/cart.png"
                                                            style="width: 14px;">
                                                                                                        ...
                                                                                                        <span class="text-center w-100 fw-bold fs-13"
                                                        onclick="addtocart('CO14I5QY856')"
                                                        id="cart_in_CO14I5QY856"> Add To
                                                        Cart </span>
                                                                                                    </a>
                                            </div>
                                            <div class="flex-grow-1">
                                                <a href="coursedetails/<?php echo $row['uuid'] ?>"
                        ...
                        <!-- <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4 hideClass"
                            ...
                            <div
                                ...
                                <div class="position-relative overflow-hidden bg-prussian-blue">
                                    ...
                                    <a href="course-details/CO09UEG2B47"
                                        class="course-card_img">
                                        <img src="assets/uploads/course/Thumb1681711110-f-SEO-Adv-thumb-1.png"
                                            class="img-fluid w-100" alt="">
                                    </a>
                                    ...
                                    <div
                                        class="align-items-center top-0 d-flex fs-12 position-absolute px-3 py-2 start-0 text-white w-100 z-index-2">
                                                                                <span class="badge-new  me-1">New</span>
                                                                                <span
                                            class="badge-business">SEO</span>
                                        <span id="savecourseCO09UEG2B47" class="ms-auto">
                                                                                        <img onclick="get_coursesaveloop(1, 'CO09UEG2B47')"
                                                src="application/modules/frontend/views/themes/default/assets/img/bookmark-1.png"
                                                class="img-fluid ms-auto " alt="" style="cursor: pointer;">
                                                                                    </span>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <h3 class="course-card__course--title  mb-0">
                                            <a href="course-details/CO09UEG2B47"
                                                class="text-decoration-none text-white">Complete SEO Masterclass</a>
                                        </h3>
                                        
                                        <div class="course-card__instructor d-flex align-items-center">
                                            <div class="card__instructor--name my-2">
                                                <a class="text-capitalize instructor-name"
                                                    href="instructor-profile-show/F30RG5SGO">Golam Mostofa Imon</a>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="course-like d-flex align-items-center">
                                                <i class="fas fa-graduation-cap fs-15 me-1 " style="color:#B5C5DB"></i>
                                                <div class="d-block">
                                                    <div class="reviews fs-12 fw-bold text-white">5</div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="course-card__hover--content">
                                        <img src="assets/uploads/course/Hover1680513495-f-SEO-mini-hover-1.png"
                                            class="course-card__hover--content___img">
                                        
                                        
                                        <a class="course-card__hover--content___icon popup-youtube"
                                            href="https://vimeo.com/806219073"
                                            autoplay>
                                            <img src="application/modules/frontend/views/themes/default/assets/img/Playicon.png"
                                                class="img-fluid" alt="">
                                        </a>
                                    ...
                                    <input type="hidden" name="course_id"
                                        id="course_id_CO09UEG2B47"
                                        value="CO09UEG2B47">
                                    <input type="hidden" name="course_name"
                                        id="course_name_CO09UEG2B47"
                                        value="Complete SEO Masterclass">
                                    <input type="hidden" name="slug"
                                        id="slug_CO09UEG2B47"
                                        value="complete-seo-masterclass">
                                    <input type="hidden" name="qty" id="qty" value="1">
                                    <input type="hidden" name="price"
                                        id="price_CO09UEG2B47"
                                        value="1500">
                                    <input type="hidden" name="old_price"
                                        id="old_price_CO09UEG2B47"
                                        value="3000">
                                    <input type="hidden" name="picture"
                                        id="picture_CO09UEG2B47"
                                        value="assets/uploads/course/Thumb1681711110-f-SEO-Adv-thumb-1.png">
                                    <input type="hidden" name="is_course_type" id="iscourse_type" value="0">
                                    
                                    <input type="hidden" name="affiliator_id" id="affiliator_id" value="">
                                    <input type="hidden" name="course_price" id="course_price" value="1500">
                                    <input type="hidden" name="student_discount" id="student_discount" value="">
                                   
                                    <div class="d-block">
                                                                                <div class="align-items-center d-flex form-check ps-0">
                                            <input class="me-1" style="width:21px;height:21px" type="radio"
                                                name="flexRadioDefault1_CO09UEG2B47"
                                                id="flexRadioDefault1_CO09UEG2B47"
                                                onclick="subscriptionchecedRadio('CO09UEG2B47')"
                                                disabled>
                                            <label class="form-check-label fw-bold opa-half course_price_cart"
                                                for="flexRadioDefault1">
                                                Subscription
                                        ...
                                        <div class="form-check d-flex align-items-center ps-0">
                                            <input class="me-1" style="width:21px;height:21px" type="radio"
                                                name="flexRadioDefault2_CO09UEG2B47"
                                                id="flexRadioDefault2_CO09UEG2B47"
                                                onclick="coursechecedRadio('CO09UEG2B47')"
                                                checked>
                                            <label
                                                class="align-items-center d-flex form-check-label fw-bold justify-content-between"
                                                style="width:100%"
                                                for="flexRadioDefault2_CO09UEG2B47">
                                                <span class="course_price_cart">Course Price <span
                                                        class="text-success"></span>
                                                </span>
                                                <span class="align-items-center d-flex  rounded text-center">
                                                    <span class="d-block fs-16 fw-bold me-2 text-success2">BDT
                                                        1,500</span>
                                                                                                        <del
                                                        class="fs-12 fw-bold text-muted2">3,000</del>
                                                                                                    </span>
                                        ...
                                        <div class="d-flex justify-content-between align-items-stretch mt-2">
                                            <div class="flex-grow-1 me-2 w-sub">
                                                                                                <a href="javascript:void(0);"
                                                    class="btn btn-dark-cerulean w-100 btn-cart-2 fs-14 "
                                                    id="cart_in_disableCO09UEG2B47">
                                                    <span class="shopping me-1 shopping_icon position-relative">
                                                        <img src="application/modules/frontend/views/themes/default/assets/img/cart.png"
                                                            style="width: 14px;">
                                                    </span>
                                                                                                        <span class="text-center w-100 fw-bold fs-13"
                                                        onclick="addtocart('CO09UEG2B47')"
                                                        id="cart_in_CO09UEG2B47"> Add To
                                                        Cart </span>
                                                                                                    </a>
                                            </div>
                                            <div class="flex-grow-1">
...
<script>
    $(document).on('click', '#holaa', function(){

        var thelink = $(this).data('linker');

        console.log(thelink);


        // this call the iframe where youtube is
        
        $(".yty").attr('src',thelink)
