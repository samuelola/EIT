...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-9RRVWVXL3J"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-9RRVWVXL3J');
    </script>

    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-11039630967"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'AW-11039630967');
    </script>
    ...
    <!-- <script>
        ...
        })(window,document,'script','dataLayer','GTM-N5DHBNS');
    </script> -->
...
<script>
  ...
  fbq('init', '1147504626139714');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=1147504626139714&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
...
<body>
    ...
    <input type="hidden" name="CSRF_TOKEN" id="CSRF_TOKEN" value="6f3c2a7425ac08485e1aaeb6805cbada">
    ...
    <input type="hidden" id="segment1" value="course-details">
    <input type="hidden" id="segment2" value="CO116Z38255">
    ...
    <!--Start Navbar -->
                    ...
                    id="navbarSticky">
                        ...
                        <a class="navbar-brand ms-0 ms-md-2"
                            href="home">
                            <img src="assets/uploads/logo/2022-01-10/602b520cd70a054bd7a0cdffa8ba0345.svg"
                                class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="mobile-main-nav">
                                <li>
                                    <a href="allcourse">
                                        ...
                                        <span class="text-uppercase">COURSES<i
                                    ...
                                    <ul>
                                        <li><a href="allcourse"
                                                ...
                                                <div>All Courses</div>
                                                                                ...
                                                                                <li>
                                            <a href="category-course/C07CY4OO"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=" fs-25"></i>
                                                </div>
                                                <div>Business Communication</div>
                                                                                ...
                                                                                <li>
                                            <a href="category-course/C18IO7XI"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C186BY8P">Ethical Hacking</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C163DN33"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C16OI2ZN">Yoga</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C10FWIQ8">Self Defense</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C22NVM7I"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C2228RAJ">Robotics</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C02U7IVS"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C0225UGZ">Pastry &amp; Baking</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C24NTUSZ"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C24TCC2D">Entrepreneurship</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C172D724">Supply Chain &amp; Logistics</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C22Y2XS4">Networking &amp; Negotiation</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C14N4NPQ"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                                <div>Creative Arts &amp; Crafts</div>
                                                <div class="has-sub-category"><i class="fas fa-angle-right"></i></div>
                                            </a>
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C30KAPEM">Calligraphy</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C14PHPJ7">Magic Skills</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C27RDNUS"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C08TKEAR">  Leadership Development    </a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C21LQFBZ"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C218Q253">PowerPoint</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C114YRMB">Ms Word</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C13QHNP9"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C13C7AA1">Personal Productivity</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C228R4XS">Professional Productivity</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C27ALR26"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C27Q5APT">Advertising</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C15HINBR">Corporate Sales</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C31XZJ8Y"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C13PETUJ">English Language</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C21U5WHO">Quran Learning</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C166FE23">Sign Language</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C25S253W"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C25HIOBS">Practical Accounting</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C302ZXF5">Investing &amp; Trading</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C202UM2C"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                                <div>Psychological Development</div>
                                                <div class="has-sub-category"><i class="fas fa-angle-right"></i></div>
                                            </a>
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C20272GI">Mental Toughness</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C176E8QN"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C173BJML">Volunteerism</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C30CDGDQ"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C30TGGQG">SEO</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C01QOO2V"> Facebook Marketing</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C1458KX4">Affiliate Marketing</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C30YVJVG"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C3089E6N">Python Programming</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C25BJZBT">Matlab Programming</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C30JLJYO"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C30TMBVS">Wordpress</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C3061E2A">Web Design</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C035T11D">Full Stack Web Development</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                                <li>
                                            <a href="category-course/C27KYUDJ"
                                                class="Selected">
                                                <div class="icon"><i
                                                        class=""></i>
                                                </div>
                                            ...
                                            <ul>
                                                                                                <li><a
                                                        href="category-course/C27SXSJW">UX/UI Design</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C27G9MF4">Animation</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C13Z8OZN">Design Software</a>
                                                </li>
                                                                                                <li><a
                                                        href="category-course/C20TNLIZ">Video Design</a>
                                                </li>
                                                                                            </ul>
                                        </li>
                                                                            </ul>
                        ...
                        <ul class="navbar-nav flex-row align-items-center">
                            ...
                            <li class="nav-item m-1">
                                <a class="border btn fw-bold me-2 text-uppercase text-white py-1 px-2 d-flex align-items-center"
                                    href="signin"><i
                                        class="fas fa-sign-in-alt me-0 me-sm-2"></i><span
                                        class="d-none d-sm-flex">Sign in</span></a>
                            </li>
                            <!-- <li class="nav-item d-none d-md-block"> -->
                            <!-- <a class="nav-link" href="admin/enterprise-signup">For Enterprise</a> -->
                            <!-- </li> -->
                            <!-- <li class="nav-item d-none d-md-block"> -->
                            <!-- <a class="nav-link" href="admin/ins-signup">For Instructor</a> -->
                            <!-- <a class="nav-link" href="https://soft11.bdtask.com/leadacademy-design/instructor-dashboard.html">For Instructor</a> -->
                            <!-- </li> -->
                            <li class="nav-item ml-md-3">
                                <a href="student-signup"
                                    class="btn-join btn-join-alabin bg-white btn fw-bold text-dark-cerulean text-uppercase d-flex align-items-center"><i
                                        class="far fa-edit me-0 me-sm-2"></i><span class="d-none d-sm-flex">join lead
                                        academy</span>                                </a>
                            </li>
...
<input type="hidden" id="course_id" name="course_id" value="CO116Z38255">
...
<div class="hero-header text-white position-relative bg-img hero2">
    <div class="bottom-0 end-0 position-absolute start-0 top-0" style="z-index: -1">
        <img src="assets/uploads/course/Cover1683794109-f-MMA-cover.png"
    ...
    <div class="container-lg hero-header_wrap position-relative">
        ...
        <div class="text-center my-3 my-md-5 ">
                ...
                href="https://vimeo.com/827582165">
        ...
        <!--End Video Icon With Popup Youtube-->
            ...
            <div class="col col-title">
                <h1 class="fw-semi-bold mb-3">
                    Self-Defense with Mixed Martial Arts</h1>
                <div class="row g-4 align-items-center">
                    <div class="col-auto">
                        <div class="avatar d-flex align-items-center">
                            <div class="avatar-img me-3">
                                                                <img src="assets/uploads/faculty/1684152249-f-MMA-hover.png"
                                    alt="">
                            </div>
                            <div class="avatar-text">
                                <div class="avatar-designation text-white-50 mb-1 fw-bold">
                                    Instructor                                </div>
                                <h5 class="h6 avatar-name mb-0">
                                    <a href="instructor-profile-show/F10L7NCD78251"
                                        class="text-white">
                                        Tahseen Shaan Leon                                    </a>
                                </h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="align-items-end g-3 justify-content-md-end row mt-3 mt-xl-0">
                    <div class="col-sm-auto">
                        <div class="d-md-flex save-share-wrap">
                            <span id="savecourseCO116Z38255" class="text-center">
                            ...
                            <a href="https://www.facebook.com/sharer.php?u=course-details/CO116Z38255"
                    ...
                    <input type="hidden" name="course_id" id="course_id_CO116Z38255" value="CO116Z38255">
                    <input type="hidden" name="course_name" id="course_name_CO116Z38255" value="Self-Defense with Mixed Martial Arts">
                    <input type="hidden" name="slug" id="slug_CO116Z38255" value="self-defense-with-mixed-martial-arts">
                    <input type="hidden" name="qty" id="qty" value="1">
                                        <input type="hidden" name="price" id="price_CO116Z38255" value="500">
                    <input type="hidden" name="old_price" id="old_price_CO116Z38255" value="1250">
                    <input type="hidden" name="picture" id="picture_CO116Z38255" value="assets/uploads/course/Thumb1683794109-f-MMA-thumb.png">
                    ...
                    <input type="hidden" name="course_price" id="course_price" value="500">
                    <input type="hidden" name="student_discount" id="student_discount" value="">
                        ...
                        <!-- <small class="d-block mt-1">get lifetime access of this course </small> -->
                                                <button type="button" onclick="addtocart('CO116Z38255')"
                            class="btn btn-light btn-lg fw-medium text-navy-blue w-100"
                            onclick="addtocart('CO116Z38255')"
                            id="cart_in_CO116Z38255">Add To Cart</button>
                        <!-- <span class="text-center w-100 fw-bold fs-13" onclick="addtocart('CO116Z38255')" id="cart_in_CO116Z38255"> Add To Cart </span> -->
                                            </div>
                                    </div>
            </div>
        </div>
                ...
                <div class="card border-0 rounded-0 shadow-sm mb-3 page-section" id="overview">
                    <div class="card-body p-4 p-xl-5">
                        ...
                        <div style="text-align: justify;" class="text_ellipse2 mb-2 moreText">
                            <p>The Self-Defense with Mixed Martial Arts course is designed to provide individuals with practical training in techniques that can be used to protect themselves in real-world situations. The course will cover a range of martial arts styles, including self-defense concepts and strategies.<br>
Throughout the course, students will learn and practice a variety of techniques, including strikes, kicks, takedowns, defense, escape, and stancing. They will also learn how to use leverage and timing to defend themselves against larger or stronger attackers.<br>
The course will emphasize the importance of situational awareness and understanding how to read and respond to potential threats. Students will also learn de-escalation techniques and how to avoid confrontations whenever possible. Females will have a strong knowledge of self-defense in difficult situations.<br>
In addition to physical training, the course will cover important topics related to self-defense, such as legal and ethical considerations, the use of force, etc. <br>
Self-Defense with Mixed Martial Arts (MMA) can be beneficial for a wide range of people. From women to children or law enforcement officers to fitness enthusiasts; anyone can be benefitted from this course.<br>
By the end of the course, students will have a solid understanding of basic self-defense principles and will have gained practical experience in a variety of martial arts techniques. They will be better prepared to protect themselves and others in potentially dangerous situations.</p>

<p>So what to wait for? Looking forward to seeing you in the course lessons.<br>
 </p>

                        </div>
                                                <button onclick="showhide()" class="bg-white border-0 fw-semi-bold p-0 text-dark-cerulean"
                            id="toggle">Read More</button>
                                            </div>
                </div>
                <!--End card-->
                <!--Start Card-->
                        ...
                        <div class="row">
                                ...
                                <p class="benifit-checked"><i class="fas fa-check"> </i>
                                    Training attire</p>
                                                        ...
                                                        <div class="col-sm-6 col-md-6">
                                <p class="benifit-checked"><i class="fas fa-check"> </i>
                                    Keep video resolution at 1080p</p>
                            </div>
                                                    </div>
                    </div>
                </div>
                ...
                <div class="card border-0 rounded-0 shadow-sm mb-3 page-section" id="learnings">
                    <div class="card-body p-4 p-xl-5">
                        <!--Start Section Header-->
                        <div class="section-header mb-4 position-relative">
                            <h4 class="h5">What Will I Learn?</h4>
                            <div class="section-header_divider"></div>
                        </div>
                        <!--End Section Header-->
                        <div class="row">
                                ...
                                <p class="benifit-checked"><i class="fas fa-check"> </i>
                                    Situational awareness</p>
                                                        ...
                                                        <div class="col-sm-6 col-md-6">
                                <p class="benifit-checked"><i class="fas fa-check"> </i>
                                    Identifying potential threats</p>
                            </div>
                                                    </div>
                    </div>
                </div>
                ...
                <div class="card border-0 rounded-0 shadow-sm mb-3 page-section" id="lessons">
                    <div class="card-body p-4 p-xl-5">
                        <!--Start Section Header-->
                        <div class="section-header mb-4 position-relative">
                            <h4 class="h5">Topics for this course                                <span class="h5 float-end">
                                    28 Lessons,  3 hr 3 min                                    <span>
                            </h4>
                            <div class="section-header_divider"></div>
                        </div>
                        <!--End Section Header-->
                        <div class="accordion course-content_accordion topics-accordion" id="CourseContent">
                                ...
                                <h2 class="accordion-header" id="PanelHeadingOne">
                                    <button
                                        ...
                                        <span>1&nbsp;-&nbsp;Course Overview</span> <span
                                            class="lesson-time ms-auto"><span>1                                                Lessons</span>&nbsp;•&nbsp;<span>
                                                0:3:5</span></span>
                                    </button>
                                </h2>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                    ...
                                                                    onclick="showCoursePreview('CO116Z38255', 'LE1176QJU1459')">Course Overview</a>
                                                                                                                                
                                                                <span class="course-duration ms-auto">
                                                                                                                                        <a href="javascript:void(0)"
                                                                        onclick="showCoursePreview('CO116Z38255', 'LE1176QJU1459')">
                                                                        <u> Preview </u> &nbsp;
                                                                    </a>
                                                                                                                                        00:03:05                                                                </span>
                                                                                                                            </button>
                                ...
                                <h2 class="accordion-header" id="PanelHeadingOne">
                                    <button
                                        ...
                                        type="button" data-bs-toggle="collapse"
                                        data-bs-target="#section_2"
                                        aria-expanded="false"
                                        aria-controls="section_2">
                                        <span>2&nbsp;-&nbsp;Technique</span> <span
                                            class="lesson-time ms-auto"><span>10                                                Lessons</span>&nbsp;•&nbsp;<span>
                                                0:51:53</span></span>
                                    </button>
                                </h2>
                                <div id="section_2" class="accordion-collapse collapse " aria-labelledby="PanelHeadingOne">
                                    <div class="accordion-body accordion-body py-3 px-4 px-md-0 px-lg-4">
                                        <div class="accordion course-content_accordion--sub"
                                            id="accordionPanelsStayOpenExample">
                                                                                        <div class="accordion-item border-0">
                                                    ...
                                                    <span> 1.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Four Basic Punches</a>
                                                    ...
                                                    <span> 2.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Palm and forearm striking</a>
                                                    ...
                                                    <span> 3.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Weak points</a>
                                                    ...
                                                    <span> 4.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">360 Defense and The High&amp; Low Guard</a>
                                                    ...
                                                    <span> 5.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Common Dodges</a>
                                                    ...
                                                    <span> 6.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Fighting Stances</a>
                                                    ...
                                                    <span> 7.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Front and Side Kicks</a>
                                                    ...
                                                    <span> 8.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Low kicks and feinting</a>
                                                    ...
                                                    <span> 9.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Elbows and knees</a>
                                                    ...
                                                    <span> 10.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Takedown defense</a>
                                ...
                                <h2 class="accordion-header" id="PanelHeadingOne">
                                    <button
                                        class="accordion-button collapsed"
                                        type="button" data-bs-toggle="collapse"
                                        data-bs-target="#section_3"
                                        aria-expanded="false"
                                        aria-controls="section_3">
                                        <span>3&nbsp;-&nbsp;Physical Conditioning</span> <span
                                            class="lesson-time ms-auto"><span>5                                                Lessons</span>&nbsp;•&nbsp;<span>
                                                1:0:28</span></span>
                                    </button>
                                </h2>
                                <div id="section_3" class="accordion-collapse collapse " aria-labelledby="PanelHeadingOne">
                                    <div class="accordion-body accordion-body py-3 px-4 px-md-0 px-lg-4">
                                        <div class="accordion course-content_accordion--sub"
                                            id="accordionPanelsStayOpenExample">
                                                                                        <div class="accordion-item border-0">
                                                    ...
                                                    <span> 1.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Upper Body Routine</a>
                                                    ...
                                                    <span> 2.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Core Routine</a>
                                                    ...
                                                    <span> 3.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Lower Body Routine</a>
                                                    ...
                                                    <span> 4.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Speed Drills</a>
                                                    ...
                                                    <span> 5.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Easy Combinations</a>
                                ...
                                <h2 class="accordion-header" id="PanelHeadingOne">
                                    <button
                                        class="accordion-button collapsed"
                                        type="button" data-bs-toggle="collapse"
                                        data-bs-target="#section_4"
                                        aria-expanded="false"
                                        aria-controls="section_4">
                                        <span>4&nbsp;-&nbsp;Mental Conditioning</span> <span
                                            class="lesson-time ms-auto"><span>5                                                Lessons</span>&nbsp;•&nbsp;<span>
                                                0:35:46</span></span>
                                    </button>
                                </h2>
                                <div id="section_4" class="accordion-collapse collapse " aria-labelledby="PanelHeadingOne">
                                    <div class="accordion-body accordion-body py-3 px-4 px-md-0 px-lg-4">
                                        <div class="accordion course-content_accordion--sub"
                                            id="accordionPanelsStayOpenExample">
                                                                                        <div class="accordion-item border-0">
                                                    ...
                                                    <span> 1.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Situational Awareness</a>
                                                    ...
                                                    <span> 2.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Neutral Stancing</a>
                                                    ...
                                                    <span> 3.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Aggression Mindset</a>
                                                    ...
                                                    <span> 4.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Distancing</a>
                                                    ...
                                                    <span> 5.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Easy Weapons</a>
                                ...
                                <h2 class="accordion-header" id="PanelHeadingOne">
                                    <button
                                        class="accordion-button collapsed"
                                        type="button" data-bs-toggle="collapse"
                                        data-bs-target="#section_5"
                                        aria-expanded="false"
                                        aria-controls="section_5">
                                        <span>5&nbsp;-&nbsp;Set Pieces</span> <span
                                            class="lesson-time ms-auto"><span>7                                                Lessons</span>&nbsp;•&nbsp;<span>
                                                0:32:28</span></span>
                                    </button>
                                </h2>
                                <div id="section_5" class="accordion-collapse collapse " aria-labelledby="PanelHeadingOne">
                                    <div class="accordion-body accordion-body py-3 px-4 px-md-0 px-lg-4">
                                        <div class="accordion course-content_accordion--sub"
                                            id="accordionPanelsStayOpenExample">
                                                                                        <div class="accordion-item border-0">
                                                    ...
                                                    <span> 1.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">From Standing: Wrist hold escape</a>
                                                    ...
                                                    <span> 2.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">From Standing: Front Choke Escape</a>
                                                    ...
                                                    <span> 3.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">From Standing: Rear Naked Choke Escape</a>
                                                    ...
                                                    <span> 4.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">From Standing: Rear Hold Escape</a>
                                                    ...
                                                    <span> 5.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">From Full Guard/Mount: Choke Defense and Escape</a>
                                                    ...
                                                    <span> 6.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Gun Disarm</a>
                                                    ...
                                                    <span> 7.&nbsp;</span>
                                                        ...
                                                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button
                                                                ...
                                                                type="button">
                                                                                                                                <a
                                                                    href="javascript:void(0)">Knife Disarm</a>
                ...
                <div class="card border-0 rounded-0 shadow-sm mb-3" id="instructor">
                    <div class="card-body p-4 p-xl-5">
                        <!--Start Section Header-->
                        <div class="section-header mb-4 position-relative">
                            <h4 class="h5">Meet Your Instructor</h4>
                            <div class="section-header_divider"></div>
                        </div>
                        <!--End Section Header-->
                        <div class="avatar d-flex mb-3">
                            ...
                            <div class="avatar-text">
                                <h5 class="instructor-name mb-1 fs-6">
                                    <a
                                        href="instructor-profile-show/F10L7NCD78251">Tahseen Shaan Leon                                    </a>
                                </h5>
                                <!-- <p class="instructor-designation text_ellipse2">
                                    <br>
                                </p> -->
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-1"><i class="fas fa-user-graduate text-warning me-1"></i>
                                        6                                        Students</li>
                                    <li class="mb-1"><i
                                            class="fas fa-book-open text-warning me-1"></i>1                                        Courses</li>
                                </ul>
                            </div>
                        </div>
                        <!-- <div class="text_ellipse2 mb-3">
                            ...
                            onclick="studentFollowInstructor('F10L7NCD78251')">Follow
            ...
            <div class="col-md-4 ps-xl-5 sticky-content">
                    ...
                    <a href="https://www.facebook.com/groups/3370940716522277" style="text-decoration: none; color:#FFC107" target="_blank">
                        <!-- Start Section Header -->
                        <div class="section-header mb-4 position-relative">
                            <h4 class="h5">Join Lead Academy Community</h4>
                            <div class="section-header_divider"></div>
                        </div>
                        <!-- End Section Header -->
                        <!-- Start Tags -->
                        <div class="tags">
                            <span class="tag-link text-white text-decoration-none d-inline-block mb-1 px-3 py-2 bg-prussian-blue"><i class="fab fa-facebook-f"></i>&nbsp;&nbsp;&nbsp;Facebook</span>
                        </div>
                        <!-- End Tags -->
                    </a>
                </div>
                    ...
                    <div class="bottom-0 end-0 overflow-hidden position-absolute start-0 top-0">
                        <img src="application/modules/frontend/views/themes/default/assets/img/sidebar-bg-01.jpg"
                            class="img-fluid" alt="">
                    </div>
                    <!--Start Section Header-->
                    <div class="section-header mb-4 position-relative">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <!-- <a class="text-white"> -->
                                                            <!-- </a> -->
                                                                                                                ...
                                                                                                                <a class="text-white">ENGLISH , BANGLA</a>
                        </div>
                                            </div>
                    <!-- <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                ...
                <div class="sidebar-block text-white mb-3 p-4 position-relative overflow-hidden">
                    ...
                    <!--End Section Header-->
                            ...
                            <span class="text-white">Professional MMA Fighter</span>
                            <!-- </a> -->
                        </li>
                                                <li class="mb-1">
                            <!-- <a href="https:" class="text-white" target="_new"> -->
                            <span class="text-white">Self-Defense</span>
                            <!-- </a> -->
                        </li>
                                                <li class="mb-1">
                            <!-- <a href="https:" class="text-white" target="_new"> -->
                            <span class="text-white">Coaching and Training</span>
                            <!-- </a> -->
                        </li>
                                                <li class="mb-1">
                            <!-- <a href="https:" class="text-white" target="_new"> -->
                            <span class="text-white">Physical trainer</span>
                            <!-- </a> -->
                        </li>
                                                                    </ul>
                                        <!-- <div class="d-flex align-items-center mb-3">
                ...
                <div class="sidebar-block bg-midnight-express text-white mb-3 p-4">
                    ...
                    <div class="tags">
                        ...
                        <span class="tag-link text-white text-decoration-none d-inline-block mb-1 px-3 py-2 bg-endeavour">Self-defense skills</span>
                        <!-- </a> -->
                                                <!-- <a href="#" class="tag-link text-white text-decoration-none d-inline-block mb-1 px-3 py-2 "> -->

                        <span class="tag-link text-white text-decoration-none d-inline-block mb-1 px-3 py-2 bg-navy-blue">Physical fitness</span>
                        <!-- </a> -->
                                                <!-- <a href="#" class="tag-link text-white text-decoration-none d-inline-block mb-1 px-3 py-2 "> -->

                        <span class="tag-link text-white text-decoration-none d-inline-block mb-1 px-3 py-2 bg-dark-cerulean">Stress relief</span>
                        <!-- </a> -->
                                                <!-- <a href="#" class="tag-link text-white text-decoration-none d-inline-block mb-1 px-3 py-2 "> -->

                        <span class="tag-link text-white text-decoration-none d-inline-block mb-1 px-3 py-2 bg-navy-blue">Discipline</span>
                        <!-- </a> -->
                                                                    </div>
                    <!--End Tags-->
                </div>
                ...
                <div class="viewe-carousel owl-carousel owl-theme">
                    <!--Start Course Card-->
                        ...
                        <div class="position-relative overflow-hidden bg-prussian-blue">
                            <!-- <div class="position-relative"> -->
                            <!--Start Course Image-->
                            <a href="course-details/CO16ECOYR52"
                                class="course-card_img">
                                <img src="assets/uploads/course/Thumb1684412207-f-Yoga-Mini-thumb-v2.1.png"
                            ...
                            <div
                                class="align-items-center top-0 d-flex fs-12 position-absolute px-3 py-2 start-0 text-white w-100 z-index-2">
                                                                ...
                                                                <span
                                    class="badge-business">Yoga</span>
                                <span id="savecourseCO16ECOYR52" class="ms-auto">
                                                                        <img onclick="coursesavecheck()"
                                        src="application/modules/frontend/views/themes/default/assets/img/bookmark-1.png"
                            ...
                            <div class="bg-prussian-blue course-card_body course_middle px-3 py-2 text-white py-12">
                                ...
                                <h3 class="course-card__course--title  mb-0">
                                    <a href="course-details/CO16ECOYR52"
                                        class="text-decoration-none text-white">রোগ ভিত্তিক যোগ ব্যায়াম</a>
                                </h3>
                                <!--End Course Title-->
                                <div class="course-card__instructor d-flex align-items-center">
                                    <div class="card__instructor--name my-2">
                                        <a class="text-capitalize instructor-name"
                                            href="instructor-profile-show/F16MY593R7302">Dr. Hirendra Kumar Das</a>
                                    </div>
                                </div>
                                <!--Start Course Hints-->
                                ...
                                <div
                                    ...
                                    <div class="course-like d-flex align-items-center">
                                        ...
                                        <div class="d-block">
                                            <div class="reviews fs-12 fw-bold text-white">49</div>
                                        </div>
                                    </div>
                            ...
                            <div class="course-card__hover--content">
                                <img src="assets/uploads/course/Hover1684412207-f-Yoga--hover.png"
                                    class="course-card__hover--content___img">
                                <!--Start Video Icon With Popup Youtube-->
                                
                                <a class="course-card__hover--content___icon popup-youtube"
                                    href="https://vimeo.com/818293593" autoplay>
                                    <img src="application/modules/frontend/views/themes/default/assets/img/Playicon.png"
                                        class="img-fluid" alt="">
                                </a>
                                                                <!--End Video Icon With Popup Youtube-->
                        ...
                        <div class="course-card_footer g-2 px-3 py-12">
                            ...
                            <!-- before purchase  -->
                            <!-- add to cart  -->
                            <input type="hidden" name="course_id" id="course_id_CO16ECOYR52" value="CO16ECOYR52">
                            <input type="hidden" name="course_name" id="course_name_CO16ECOYR52" value="রোগ ভিত্তিক যোগ ব্যায়াম">
                            <input type="hidden" name="slug" id="slug_CO16ECOYR52" value="রোগ-ভিত্তিক-যোগ-ব্যায়াম">
                            <input type="hidden" name="qty" id="qty" value="1">
                            <input type="hidden" name="price" id="price_CO16ECOYR52" value="0">
                            <input type="hidden" name="old_price" id="old_price_CO16ECOYR52" value="">
                            <input type="hidden" name="picture" id="picture_CO16ECOYR52" value="assets/uploads/course/Thumb1684412207-f-Yoga-Mini-thumb-v2.1.png">
                            <input type="hidden" name="is_course_type" id="iscourse_type" value="0">
                            <!-- add to cart  -->
                            ...
                            <div class="d-block">
                                ...
                                <div class="align-items-center d-flex form-check ps-0">
                                    <input class="me-1" style="width:21px;height:21px" type="radio"
                                        name="flexRadioDefault1_CO16ECOYR52"
                                        id="flexRadioDefault1_CO16ECOYR52"
                                        onclick="subscriptionchecedRadio('CO16ECOYR52')"
                                        disabled>
                                ...
                                <div class="align-items-center d-flex form-check ps-0">
                                    <input class="me-1" style="width:21px;height:21px" type="radio"
                                        name="flexRadioDefault2_CO16ECOYR52"
                                        id="flexRadioDefault2_CO16ECOYR52"
                                        onclick="coursechecedRadio('CO16ECOYR52')" disabled>
                                    <label
                                ...
                                <div class="d-flex justify-content-between align-items-stretch mt-2">
                                    <div class="flex-grow-1 me-2 w-sub">
                                        <a href="javascript:void(0)"
                                            ...
                                            onclick="addtomycourse('CO16ECOYR52')">
                                            <span class="shopping me-1 shopping_icon position-relative">
                                                <img src="application/modules/frontend/views/themes/default/assets/img/cart.png"
                                                    style="width: 14px;">
                                            </span>
                                            <span class="text-center w-100 fw-bold fs-13"> Enroll Now </span>
                                        </a>
                                    </div>
                                    <div class="flex-grow-1">
                                        <a href="course-details/CO16ECOYR52"
                                            ...
                                            <span class="shopping me-1 shopping_icon position-relative">
                                                <img class="me-1"
                                                    src="application/modules/frontend/views/themes/default/assets/img/details.png"
                                                    style="width: 14px;">
                                            </span>
        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <ul class="socail-share list-unstyled d-flex mb-0 justify-content-center">
                    <li><a href="https://www.facebook.com/sharer.php?u=course-details/CO116Z38255"
                    ...
                    <li><a href="https://twitter.com/share?text=Self-Defense with Mixed Martial Arts &url=course-details/CO116Z38255 "
                            target="_blank" class="d-block text-center me-3 text-muted">
                            <div class="socail-share_icon twitter"><i class="fab fa-twitter"></i></div>Twitter
                        </a></li>
                    <li><a href="https://api.whatsapp.com/send?text=[Self-Defense with Mixed Martial Arts] [course-details/CO116Z38255]"
                    ...
                    <li><a href="mailto:?subject=Self-Defense with Mixed Martial Arts &body=<p>The Self-Defense with Mixed Martial Arts course is designed to provide individuals with practical training in techniques that can be used to protect themselves in real-world situations. The course will cover a range of martial arts styles, including self-defense concepts and strategies.<br>
Throughout the course, students will learn and practice a variety of techniques, including strikes, kicks, takedowns, defense, escape, and stancing. They will also learn how to use leverage and timing to defend themselves against larger or stronger attackers.<br>
The course will emphasize the importance of situational awareness and understanding how to read and respond to potential threats. Students will also learn de-escalation techniques and how to avoid confrontations whenever possible. Females will have a strong knowledge of self-defense in difficult situations.<br>
In addition to physical training, the course will cover important topics related to self-defense, such as legal and ethical considerations, the use of force, etc. <br>
Self-Defense with Mixed Martial Arts (MMA) can be beneficial for a wide range of people. From women to children or law enforcement officers to fitness enthusiasts; anyone can be benefitted from this course.<br>
...
<p>So what to wait for? Looking forward to seeing you in the course lessons.<br>
 ...
 PLEASE VISIT THIS LINK:  course-details/CO116Z38255"
                            class="d-block text-center me-3 text-muted">
                            <div class="socail-share_icon envelope"><i class="far fa-envelope"></i></div>Email
                        </a></li>
                    <li>
                        <a href="https://www.facebook.com/dialog/send?link=course-details/CO116Z38255&app_id=311161661010577&redirect_uri=course-details/CO116Z38255"
                ...
                <div class="col-md-7">
                    <div class="input-group">
                        ...
                        <button class="btn btn-primary fw-medium" type="button" id="button-addon2"
                            onclick="subscriber_save()">Newsletter</button>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <div class="footer-logo mb-4">
                    <img src="assets/uploads/logo/2021-10-06/2f5b93ccf352717677e689025517a384.png"
                        class="img-fluid" alt="">
                </div>
<!--                <p class="mb-0 text">
...
<div class="sub-footer bg-prussian-blue text-white py-4">
    <div class="container-lg d-sm-flex align-items-center justify-content-between">
        ...
        <div class="text-center text-md-start">
            <span class="fw-semi-bold ms-3 px-3 py-2 text-warning"><h4> Hotline +88 01894988285 </h4></span>
        </div>
        ...
        <ul class="footer-social list-unstyled mb-0 d-flex align-items-center justify-content-center mt-3 mt-sm-0">
            ...
            <li class="mx-1">
                <a href="https://www.facebook.com/leadacademy.com.bd">
            ...
            <li class="mx-1">
                <a
                    href="https://www.instagram.com/leadacademybd/">
            ...
            <li class="mx-1">
                <a href="https://www.youtube.com/c/LEADLeadershipExcellenceDevelopment">
...
<!-- lead inhouse by @Salehin 26062022 -->
    ...
    <div class="container-lg">
        <div class="align-items-center d-block d-sm-flex mt-4">
            <div class="d-block minw_65 text-center text-md-start">
                <h6 class="fs-12 me-2 text-capitalize">pay with</h6>
            </div>
            <div class="d-flex flex-wrap justify-content-center logo_ssl-middle">
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/4202f62c20e32186e48bb9bd81caa4ac.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/e77506933bbbf39c9f801a0735c307de.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/d4bc18884cd2275a6b8e4bae2415eddd.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/fbb601f269dc4b56b0551e1358931889.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/98659aee2658d5422ef6a49a5a9d7079.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/4f29d19000c29b6a2d764148567d5d56.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/4ace84ca71d9b5caf1116efe208d51fc.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/ae830367310b54da66613c0486ea62de.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/ed2624f746b64ccb5ef8b91887973760.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/fa88e463dadd69ff8c252a22a60ddc62.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/54330eabec3e06fa0c3404a2ccbfc919.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/b3e2612ef1258954809761869acb1319.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/ee319ec322dd3a652247b3f3a0fda070.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/39b10776a247780332febdc50cb591fa.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/31bf2b4ce063e99c77af23c967fd9180.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/61a66cc509414f5e4a062589c1db84a4.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/01ec4d80cc7d93bbd1a8a736112997dc.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/642abc6c2afacf6b14c355cef9af7ac9.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/9ffa90ef9d656941de6b432117196266.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/d945e8af79c2f996f2181a585a0ff208.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/aa5fd4485e7c79c037dc4b9eb70db4f7.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/b327839211545286b70ef32282395fd7.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/6c51f0ca369104a695b8625e7c575716.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/d7d7887c7fd693a6eadad50ac2891804.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/cbff4361d72559a906eae9cd0aa88975.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/b96d58453b7fb151827703e3fe91c1a6.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/f95cf153fc24e078d58274b6c3784a10.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/21e9aa4ae7b63a6f1df7b13f2e26e523.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/15dfd30ca61169064173546a0f792850.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/1dbf20776805ca589a3f8d8e90b79dbd.png" class="img-fluid"
                        alt="">
                </a>
                                <a href="#" class="logo_ssl-block">
                    <img src="assets/uploads/paywith/2022-03-08/20c1aa2c2d5fc2939785dd0aaabec2c5.png" class="img-fluid"
                        alt="">
                </a>
                            </div>
            <div class="d-block maxw_75 ms-md-2 mt-4 mt-sm-0 mx-auto text-center">
                <h6 class="fs-12">Verified by:</h6>
                <img src="application/modules/frontend/views/themes/default/assets/img/32.png"
                    class="img-fluid" alt="">
            </div>
        </div>
    </div>
