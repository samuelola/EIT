  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content" style="background-color: #000;">
      <div class="modal-header" style="border-bottom: 1px solid transparent;">
        ...
        <button type="button" class="btn-close" style="color:#fff;" data-bs-dismiss="modal" aria-label="Close">X</button>
      </div>
    ...
    <iframe id="Geeks3" width="765" height="400" class="yty" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav flex-row align-items-center">
                            ...
                            <li class="nav-item dropdown dmenu dropdown-user">
                                <a id="waylogo1" class="nav-link dropdown-toggle" href="#" id="user" role="button"
                                ...
                                <div class="position-relative overflow-hidden bg-prussian-blue">
                                    ...
                                    <a href="#"
                                        ...
                                        <img src="../admin/dashboard/<?php echo $row['image']  ?>"
                                            class="img-fluid w-100" alt="" style="height: 220px;">
                                    </a>
                                    <!--Start items badge-->
                                    <div
                                        ...
                                        <div class="course-card__instructor d-flex align-items-center">
                                            <div class="card__instructor--name my-2">
                                                <a class="text-capitalize instructor-name"
                                                    href="#"><?php echo ucfirst($row['author']) ?></a>
                                            </div>
                                        </div>
                                        <!--Start Course Hints-->
                                        <table
                                    ...
                                    <div class="d-block">
                                        ...
                                        <div class="d-flex justify-content-between align-items-stretch mt-2">
                                            ...
                                            <!-- <div class="flex-grow-1">
                                                <a href="editcourse.php?id=<?php echo $row['uuid'] ?>"
